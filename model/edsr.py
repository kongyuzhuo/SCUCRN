...
class EDSR(nn.Module):
    def __init__(self, scale_factor=2):
        ...
        self.conv_input = nn.Conv2d(
            in_channels=3, out_channels=256, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.conv_output = nn.Conv2d(
            in_channels=256, out_channels=3, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def forward(self, x):
        ...
        out = self.add_mean(out)  # [8,3,32,128]
        return out
