...
def str_filt(str_, voc_type):
    alpha_dict = {
        'digit': string.digits,  # 数字0-9字符串
        'lower': string.digits + string.ascii_lowercase,  # 数字+小写字母
        'upper': string.digits + string.ascii_letters,  # 数字+字母（大小写）
        'all':   string.digits + string.ascii_letters + string.punctuation  # 数字+字母+符号
    }
    if voc_type == 'lower':
        str_ = str_.lower()
    for char in str_:
